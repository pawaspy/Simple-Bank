...
func (x *CreateVerifyEmailRequest) Reset() {
	*x = CreateVerifyEmailRequest{}
	mi := &file_rpc_verify_email_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateVerifyEmailRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateVerifyEmailRequest) ProtoMessage() {}

func (x *CreateVerifyEmailRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_verify_email_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use CreateVerifyEmailRequest.ProtoReflect.Descriptor instead.
func (*CreateVerifyEmailRequest) Descriptor() ([]byte, []int) {
	return file_rpc_verify_email_proto_rawDescGZIP(), []int{0}
}

func (x *CreateVerifyEmailRequest) GetEmailId() int64 {
	if x != nil {
		return x.EmailId
	}
	return 0
...
func (x *CreateVerifyEmailRequest) GetSecretCode() string {
	if x != nil {
		return x.SecretCode
	}
	return ""
...
func (x *CreateVerifyEmailResponse) Reset() {
	*x = CreateVerifyEmailResponse{}
	mi := &file_rpc_verify_email_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateVerifyEmailResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateVerifyEmailResponse) ProtoMessage() {}

func (x *CreateVerifyEmailResponse) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_verify_email_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateVerifyEmailResponse.ProtoReflect.Descriptor instead.
func (*CreateVerifyEmailResponse) Descriptor() ([]byte, []int) {
	return file_rpc_verify_email_proto_rawDescGZIP(), []int{1}
}

func (x *CreateVerifyEmailResponse) GetIsVerified() bool {
	if x != nil {
		return x.IsVerified
	}
	return false
...
const file_rpc_verify_email_proto_rawDesc = "" +
	"\n" +
	"\x16rpc_verify_email.proto\"V\n" +
	"\x18CreateVerifyEmailRequest\x12\x19\n" +
	"\bemail_id\x18\x01 \x01(\x03R\aemailId\x12\x1f\n" +
	"\vsecret_code\x18\x02 \x01(\tR\n" +
	"secretCode\"<\n" +
	"\x19CreateVerifyEmailResponse\x12\x1f\n" +
	"\vis_verified\x18\x01 \x01(\bR\n" +
	"isVerifiedB#Z!github.com/pawaspy/simple_bank/pbb\x06proto3"
...
var file_rpc_verify_email_proto_goTypes = []any{
	(*CreateVerifyEmailRequest)(nil),  // 0: CreateVerifyEmailRequest
	(*CreateVerifyEmailResponse)(nil), // 1: CreateVerifyEmailResponse
}
