...
type SimpleBankClient interface {
	...
	VerifyEmail(ctx context.Context, in *CreateVerifyEmailRequest, opts ...grpc.CallOption) (*CreateVerifyEmailResponse, error)
}
...
func (c *simpleBankClient) VerifyEmail(ctx context.Context, in *CreateVerifyEmailRequest, opts ...grpc.CallOption) (*CreateVerifyEmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateVerifyEmailResponse)
...
type SimpleBankServer interface {
	...
	VerifyEmail(context.Context, *CreateVerifyEmailRequest) (*CreateVerifyEmailResponse, error)
...
func (UnimplementedSimpleBankServer) VerifyEmail(context.Context, *CreateVerifyEmailRequest) (*CreateVerifyEmailResponse, error) {
...
func _SimpleBank_VerifyEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateVerifyEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).VerifyEmail(ctx, req.(*CreateVerifyEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
